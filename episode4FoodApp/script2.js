...
//state variable react hook is normal js function given to us by react prebuild it comes wit logic
//two mosst imoportant hooks
// useState() - superpowerfull state variables in react
//useEffect()
// now to crate powerfull react variable called as state variable
let restaurantList = [
    {
        type: "restaurant",
        data: {
...
const RestaurantCard = (resDat) => {
    const {
        name, cuisines, avgRating, cloudinaryImageId
    } = resDat.resDat;
    return (
        <div className='card'>
            <img src={IMG_CDN_URL + cloudinaryImageId} className='resto-image1'></img>
            <h3 >{name}</h3>
            <h4>{cuisines}</h4>
            <p>{avgRating}</p>
        </div>
        ...
        <div className='body'>
            <div className='filter'>
                <button className='filter-btn' onClick={
                    () => {
                        ...
                        //filter logic to filter out restaurant
                        // now ui doesn't get updates
                    }
            ...
            <div className='restaurant-container'>
                ...
                {listOfRestaurant.map((res) => {
                    return <RestaurantCard key={res.data.id} resDat={res.data} />;
                })
                }
            </div>
        </div >
